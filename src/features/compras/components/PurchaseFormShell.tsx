...
interface PurchaseFormShellProps {
  title: string;
  onClose: () => void;
...
/**
 * Responsive layout shell for PurchaseForm. Renders a fullscreen bottom-sheet on
 * mobile and a centred modal on desktop. Owns no form state — just structure.
 */
export default function PurchaseFormShell({
  title,
  onClose,
  isSubmitting,
  submitDisabled,
