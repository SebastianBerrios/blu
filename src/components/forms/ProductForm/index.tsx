...
import { X, ChefHat, Calculator, Receipt, ArrowRight, ArrowLeft } from "lucide-react";
...
export default function ProductForm({
  ...
  // Shared form fields content (used in both mobile and desktop views)
  const formFields = (
    <>
      {/* Información Básica */}
            ...
            {TARGET_PERCENTAGE_OPTIONS.map((option) => {
              ...
              return (
                <button
                  ...
                  className={`
                    px-3 py-2.5 min-h-[44px] rounded-md text-xs font-medium transition-all border
                    ${
                      isActive
